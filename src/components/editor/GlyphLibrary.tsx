...
function GlyphLibrary({
  ...
  return (
    <aside className="min-w-0 rounded-2xl bg-white/90 p-5 shadow-[0_18px_36px_rgba(27,26,23,0.12)] flex flex-col gap-4 sticky top-6 self-start max-h-[calc(100vh-80px)] overflow-hidden max-[1100px]:static max-[1100px]:max-h-none">
