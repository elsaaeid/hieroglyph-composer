  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-40 mx-8 flex flex-wrap items-center justify-between gap-4 rounded-2xl bg-white/80 px-6 py-4 shadow-[0_20px_40px_rgba(27,26,23,0.08)] backdrop-blur">
      <div>
        ...
        <h1 className="header-title mt-1 font-[Fraunces] text-emerald-950">
      ...
      <div className="flex flex-wrap gap-2">
        <div className="relative group">
          <button
            className="header-button cursor-pointer rounded-full bg-emerald-900 px-4 py-2 font-semibold text-amber-50 shadow transition hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(29,59,47,0.2)]"
        ...
        <div className="relative group">
          <button
            className="header-button cursor-pointer rounded-full border border-emerald-900/30 px-4 py-2 font-semibold text-emerald-900 transition hover:-translate-y-0.5"
            onClick={onPaste}
          >
            Paste
          </button>
